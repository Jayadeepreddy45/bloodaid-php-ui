...
const url = 'https://bloodaid-py-api.onrender.com' 
...
function loadcarousel() {
  $("#main_content")
    .html(`<style>
        ...
        <div id="carouselExampleCaptions" class="carousel" class="carousel slide" data-bs-ride="carousel">
...
`);
  $("#register_form").on("submit", function (e) {
    ...
    $.ajax({
      url: url + "/register.php", // API endpoint
      type: "POST",
      dataType: "json",
